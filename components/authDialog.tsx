        ...
        {!showSignup ? (
          <>
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-orange-600">Whisk</h2>
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full h-11 mt-2 rounded-lg bg-orange-600 hover:bg-orange-700 text-white font-semibold cursor-pointer">
                Sign In
              </Button>
            </div>
